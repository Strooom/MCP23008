...
class MCP23008 {
  public:
    ...
    // could implement these later, but currently I don't need them
    ...
    void writeRegister(registerAddress address, uint8_t value);        // write a value to a register at address xx
